...
class TestUser(unittest.TestCase):
    ...
    def test_description_attr(self):
        ''' Test that self.p has attr description and that it is a str type. '''
        assert hasattr(self.p, 'description')
        assert type(self.p.description) == str

    def test_number_rooms_attr(self):
        ''' Test that self.p has attr number_rooms and that it is an int type. '''
        assert hasattr(self.p, 'number_rooms')
        assert type(self.p.number_rooms) == int

    def test_number_bathrooms_attr(self):
        ''' Test that self.p has attr number_bathrooms and that it is an int type. '''
        assert hasattr(self.p, 'number_bathrooms')
        assert type(self.p.number_bathrooms) == int

    def test_max_guest_attr(self):
        ''' Test that self.p has attr max_guest and that it is an int type. '''
        assert hasattr(self.p, 'max_guest')
        assert type(self.p.max_guest) == int

    def test_price_by_night_attr(self):
        ''' Test that self.p has attr price_by_night and that it is an int type. '''
        assert hasattr(self.p, 'price_by_night')
        assert type(self.p.price_by_night) == int

    def test_latitude_attr(self):
        ''' Test that self.p has attr latitude and that it is a float type. '''
        assert hasattr(self.p, 'latitude')
        assert type(self.p.latitude) == float

    def test_longitude_attr(self):
        ''' Test that self.p has attr longitude and that it is a float type. '''
